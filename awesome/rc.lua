...
tags = {
	names  = { "dev", 2, "talk", "prod", "mail",
				6, 7, 8, 9 } ,
	layout = { layouts[2], layouts[2], layouts[3], layouts[4], layouts[2],
...
mytextbox1.text =  '<span font_desc="monospace">          </span>'
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ altkey,           }, "h",      function (c) c.minimized = not c.minimized    end),
    awful.key({ altkey,           }, "m",
        function (c)
