...
function! Tlist_Get_Tagname_By_Line(...)
	...
	let tag_scope = s:Tlist_Extract_Tag_Scope(s:tlist_{fidx}_{tidx}_tag)
	if tag_scope != ""
		let tag_scope = tag_scope . " "
	endif
...
function! s:Tlist_Menu_Init()
    ...
    augroup TagListMenuCmds
        ...
        if !g:Tlist_Process_File_Always
            autocmd BufEnter * call s:Tlist_Update_Current_File()
            autocmd BufWrite * call s:Tlist_Update_Current_File()
        endif
